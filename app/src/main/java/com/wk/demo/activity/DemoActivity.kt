...
class DemoActivity : AppCompatActivity() {
  ...
  @SuppressLint("StaticFieldLeak") private fun loadData() {
    ...
    task = object : AsyncTask<Void, Void, Void>() {
      override fun doInBackground(vararg params: Void): Void? {
        candleEntries = DataUtils.getCandelData(this@DemoActivity, candleAdapter!!.getScale())
        depthEntries = DataUtils.getDepthData(
            this@DemoActivity, depthAdapter!!.getScale(),
