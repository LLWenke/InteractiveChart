...
public class XAxisTextMarker extends AbsMarker<AbsRender> {
  private static final String TAG = "XAxisTextMarker";
  ...
  @Override public void onDrawMarkerView(Canvas canvas, RectF viewRect,
