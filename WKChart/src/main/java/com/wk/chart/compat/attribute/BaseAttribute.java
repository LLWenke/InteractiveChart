...
public class BaseAttribute {
   ...
   * 与 X 轴标尺刻度有关属性
   */
  public int axisCount = 5; // X轴行数
  public float axisWidth = 3f; // X轴线条宽度
  public int axisColor = 0x1Affffff; // X轴线条颜色
  public int axisDiffColor = 0xff707d8a; // X轴线条diff颜色
  public float axisLabelSize = 26; // X 轴标签字符大小
  public float axisLabelMarginTop = 0; // X 轴标签上边距
  public float axisLabelMarginBottom = 0; // X 轴标签下边距
  public int axisLabelColor = 0xff8c99a6; // X 轴标签字符颜色

  /**
   * 与 Y 轴标尺刻度有关属性
   */
  public int gridCount = 4; // Y轴列数
  public float gridWidth = 3f; // Y轴线条宽度
  public float gridMarkLineLength = 12f; // Y轴刻度线长度
  public int gridColor = 0x1Affffff; //  Y轴线条颜色
  public boolean gridIsHide = false;//Y轴线条是否显示
  public float gridLabelSize = 26; // Y 轴标签字符大小
  public int gridLabelColor = 0xff8c99a6; // Y 轴标签字符颜色
  public int gridLabelDiffColor = 0xffffffff; // Y 轴标签字符diff颜色
  public float gridLabelLRMargin = 16f;//Y 轴标签左右Margin
  public float gridLabelTBMargin = 8f;//Y 轴标签上下Margin
  public GridLabelLocation gridLabelLocation = GridLabelLocation.LEFT; // Y 轴标签显示位置
  ...
  public float xHighlightWidth = 3f; // X高亮线条宽度
  ...
  public float yHighlightWidth = 3f; // Y高亮线条宽度
   ...
   * 涨跌有关的属性
   */
  public int increasingColor = 0xff2cc597; // 上涨颜色
  public int decreasingColor = 0xffff6262; // 下跌颜色
  public int increasingDiffColor = 0x822cc597; // 上涨diff颜色
  public int decreasingDiffColor = 0x82ff6262; // 下跌diff颜色
   ...
   * 与股票指标有关的属性
   */
  public float centerLineWidth = 3f; // 视图中心线宽度
  public int centerLineColor = 0xffffffff; // 视图中心线颜色
  public float normLineWidth = 3f; // 指标线宽度
