...
public class MeasureUtils {
  ...
  public MeasureUtils(@NonNull BaseAttribute attribute) {
    ...
    measurePaint.setTextSize(attribute.axisLabelSize);
  ...
  public float childViewHeightMeasure(float height) {
    ...
    float viewIntervalCount = attribute.axisLabelMarginTop
        + rect.height()
        + attribute.axisLabelMarginBottom;
    float proportion = 1f;
   ...
   * 更新视图集合
   */
  public void chartModuleNotifyDataSetChanged(List<AbsChartModule> modules) {
    chartModules.clear();
